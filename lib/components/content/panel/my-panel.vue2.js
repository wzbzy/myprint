...
var _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const batchMoveMenu = vueDemi.reactive({
      visible: false,
      x: 0,
      y: 0
    });
        ...
        vue.createElementVNode("div", _hoisted_3, [
          ...
          vue.createElementVNode(
            "div",
            {
              ...
              onScroll: scroll,
              onWheel: wheel,
              onContextmenu: vue.withModifiers(showBatchMoveMenu, ["prevent"]),
          ...
          vue.unref(batchMoveMenu).visible ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
            ...
            vue.createElementVNode(
              "div",
              {
                ...
                style: vue.normalizeStyle({ left: vue.unref(batchMoveMenu).x + "px", top: vue.unref(batchMoveMenu).y + "px" }),
                onClick: _cache[2] || (_cache[2] = vue.withModifiers(() => {
                }, ["stop"]))
              },
              [
                vue.unref(panel).pageHeader ? (vue.openBlock(), vue.createElementBlock(
                  "button",
                  {
                    key: 0,
                    type: "button",
                    onClick: _cache[0] || (_cache[0] = ($event) => moveSelectedElementsTo(vue.unref(panel).pageHeader))
                  },
                  vue.toDisplayString(_ctx.i18n("handle.moveToPageHeader")),
                  1
                  /* TEXT */
                )) : vue.createCommentVNode("v-if", true),
                vue.unref(panel).pageFooter ? (vue.openBlock(), vue.createElementBlock(
                  "button",
                  {
                    key: 1,
                    type: "button",
                    onClick: _cache[1] || (_cache[1] = ($event) => moveSelectedElementsTo(vue.unref(panel).pageFooter))
                  },
                  vue.toDisplayString(_ctx.i18n("handle.moveToPageFooter")),
                  1
                  /* TEXT */
                )) : vue.createCommentVNode("v-if", true)
              ],
