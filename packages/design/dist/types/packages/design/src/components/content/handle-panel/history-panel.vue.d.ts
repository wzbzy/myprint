import { undoPanel, redoPanel } from '@myprint/design/utils/historyUtil';
...
declare const _default: import("vue").DefineComponent<{}, {
    ...
    readonly redoStack: import("vue").Ref<import("@vueuse/core").UseRefHistoryRecord<import("@myprint/design/utils/historyUtil").History | {
        label: string;
        content: string;
    }>[], import("@vueuse/core").UseRefHistoryRecord<import("@myprint/design/utils/historyUtil").History | {
        label: string;
        content: string;
    }>[]>;
    readonly undoPanel: typeof undoPanel;
    readonly redoPanel: typeof redoPanel;
    readonly history: import("vue").Ref<import("@vueuse/core").UseRefHistoryRecord<import("@myprint/design/utils/historyUtil").History | {
        label: string;
        content: string;
    }>[], import("@vueuse/core").UseRefHistoryRecord<import("@myprint/design/utils/historyUtil").History | {
        label: string;
