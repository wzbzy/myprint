...
import TipIcon from './tip-icon.vue.mjs';
import { hasStyle } from '../../../constants/common.mjs';
import { ActionEnum } from '../../../utils/historyUtil.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    const disabled = computed(() => {
      ...
      for (let currentElementElement of appStore.currentElement) {
        if (!hasStyle(currentElementElement.type, props.enableProps)) {
          return true;
        }
      }
      return false;
    ...
    function change(val) {
      ...
      mitt.emit("panelSnapshot", { action: ActionEnum.UPDATE_STYLE, elementList: appStore.currentElement });
    }
    return (_ctx, _cache) => {
      return openBlock(), createBlock(TipIcon, {
...
//# sourceMappingURL=style-icon.vue2.mjs.map
