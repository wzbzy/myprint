import { valueUnit, getPrintRealHeight } from './elementUtil.mjs';
import { printCssStyle } from './utils.mjs';
...
function iFramePrint(panel, html) {
  ...
  linkElement.textContent = printCssStyle();
...
export { getPrintElementHtml, iFramePrint, tableColClone };
//# sourceMappingURL=myprint.mjs.map
