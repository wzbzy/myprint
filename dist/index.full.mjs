import { defineComponent, reactive, ref, computed, onMounted, onUnmounted, watch, openBlock, createElementBlock, Fragment, createElementVNode, mergeProps, unref, createVNode, nextTick, renderList, normalizeStyle, createBlock, resolveComponent, withCtx, createCommentVNode, toDisplayString as toDisplayString$1, createTextVNode, h as h$2, getCurrentInstance, effectScope, inject, shallowRef, onBeforeMount, isRef, Text, markRaw, toRaw, hasInjectionContext, isReactive, getCurrentScope, onScopeDispose, toRefs, render, readonly, provide, useSlots, normalizeClass, withDirectives, vModelText, vShow, renderSlot, resolveDynamicComponent, Teleport, pushScopeId, popScopeId } from 'vue';
      ...
      return openBlock(), createElementBlock(
        ...
        [
          createElementVNode("section", mergeProps({ class: "design-container-root cursor-resize" }, _ctx.$attrs, {
            ...
            createElementVNode("aside", _hoisted_2$2, [
              createVNode(widget, {
            ...
            createElementVNode("main", _hoisted_3$2, [
...
async function autoPage(previewEl, pageList, panel, previewDataList) {
  ...
  if (panel.pageSize == "AutoHeight") {
    ...
    if (lastElementChild) {
      ...
      pageList[0].height = px2unit$1(rect.bottom, panel);
  ...
  async function autoTextElement(previewData, first) {
    ...
    if (previewWrapper.y + px2unit$1(height, panel) < previewContext.bottom) {
      return false;
    }
  ...
  async function autoTableRow(previewContext2, previewDataList2, index) {
    ...
    for (; i < previewDataList2.length + tableStatisticsSize; i++) {
      ...
      if (previewWrapper.option.tableHeightType == "FIXED") {
        if (table.childNodes[1].clientHeight > unit2px$1(previewWrapper.height, panel)) {
          if (i == index) {
      ...
      if (await isNeedNewPage(unit2px$1(previewWrapper.y, panel) + table.clientHeight, unit2px$1(previewContext2.bottom, panel))) {
        previewWrapper.tableBodyList.pop();
        previewDataTmpList.pop();
        statisticsData(previewDataTmpList, statisticsListWrapper);
  ...
  async function computeBottom(previewWrapper) {
    ...
    return numberUtil.toFixed(px2unit$1(numberUtil.sumScale(div.offsetTop, div.offsetHeight), panel));
  }
  async function computeTop(previewWrapper) {
    ...
    const div = previewWrapper.target;
    return numberUtil.toFixed(px2unit$1(div.offsetTop, panel));
  }
  async function computeTextHeight(previewWrapper, previewDataTmp) {
    ...
    const height = previewWrapper.target.clientHeight;
    return previewWrapper.y + px2unit$1(height, panel) < previewContext.bottom;
  }
...
var _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const configStore = useConfigStore$1();
    const data = reactive({
      dialogVisible: false,
    ...
    const printList = computed(() => {
      return MyPrinter$1.getPrinterList().map((res) => {
        return {
          label: res.name,
          value: res.name
        };
    ...
    function downloadPdf() {
      if (MyPrinter$1.clientConnectIs()) {
        myPrintClientService$1.print({
          ...
          if (blob) {
            download$1(blob, panel.value.name + ".pdf");
          }
        }).catch((e) => {
          printResult(data.taskId, {
            status: "ERROR",
        ...
        toPdf(previewContentRef.value, {
          width: unit2px$1(panel.value.width, panel.value),
          height: unit2px$1(panel.value.height, panel.value)
        }).then((blob) => {
          download$1(blob, panel.value.name + ".pdf");
          printResult(data.taskId, {
            status: "SUCCESS",
          ...
          createElementVNode("div", _hoisted_1, [
            ...
            createElementVNode("div", _hoisted_5, [
              createElementVNode(
                "div",
                null,
                "\u540D\u79F0\uFF1A" + toDisplayString$1(unref(panel).name),
                1
                /* TEXT */
              ),
              createCommentVNode("                <div>\u6253\u5370\u4EFD\u6570\uFF1A\u6D4B\u8BD5</div>"),
              unref(MyPrinter$1).clientConnectIs() ? (openBlock(), createElementBlock(
                Fragment,
                { key: 0 },
                [
                  createElementVNode("div", null, [
                    createTextVNode(
                      toDisplayString$1(unref(i18n$1)("toolbar.printer")) + "\uFF1A ",
                      1
                      /* TEXT */
                    ),
                  ...
                  createVNode(MyButton, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(
                        toDisplayString$1(unref(i18n$1)("toolbar.print")),
                        1
                        /* TEXT */
                      )
                    ]),
              ...
              createVNode(MyButton, {
                ...
                default: withCtx(() => [
                  createTextVNode(
                    toDisplayString$1(unref(i18n$1)("toolbar.chrome.print")),
                    1
                    /* TEXT */
                  )
                ]),
              ...
              createVNode(MyButton, {
                ...
                default: withCtx(() => [
                  createTextVNode(
                    toDisplayString$1(unref(i18n$1)("preview.download.pdf")),
                    1
                    /* TEXT */
                  )
                ]),
              ...
              createVNode(MyButton, {
                ...
                default: withCtx(() => [
                  createTextVNode(
                    toDisplayString$1(unref(i18n$1)("common.close")),
                    1
                    /* TEXT */
                  )
                ]),
...
function useI18nForLegacy(instance, scope, root, options = {} // eslint-disable-line @typescript-eslint/no-explicit-any
    ...
    // prettier-ignore
    const _datetimeFormats = ref(isPlainObject$3(options.datetimeFormats)
        ? options.datetimeFormats
        : { [_locale.value]: {} });
    // prettier-ignore
    const _numberFormats = ref(isPlainObject$3(options.numberFormats)
        ? options.numberFormats
        : { [_locale.value]: {} });
    // prettier-ignore
...
function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
    ...
    const store = reactive(((((typeof __VUE_PROD_DEVTOOLS__ !== 'undefined' && __VUE_PROD_DEVTOOLS__)) && !("production" === 'test')) && IS_CLIENT)
        ? assign({
            _hmrPayload,
...
function installPrinter(app) {
  ...
  if (!previewNode) {
    previewNode = h$2(previewPanelView, {});
    const container = document.createElement("div");
...
function mountDesign(app, props, element) {
  const printNode = h$2(DesignPanel, props == null ? {} : props);
...
const st = (e) => (pushScopeId("data-v-18925ba6"), e = e(), popScopeId(), e);
const it = /* @__PURE__ */ st(() => /* @__PURE__ */ createElementVNode("div", { class: "vc-alpha-slider__bar-handle" }, null, -1));
const ct = [
  it
];
...
function ft(e, t, o, n, i, l) {
  return openBlock(), createElementBlock("div", ht, [
    (openBlock(true), createElementBlock(Fragment, null, renderList(e.palettes, (a, r) => (openBlock(), createElementBlock("div", {
      key: r,
      class: "vc-compact__row"
    }, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(a, (c, k) => (openBlock(), createElementBlock("div", {
        key: k,
...
const Ct = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    const o = getCurrentInstance(), n = {
      ...
      s: 1,
      v: 1
    }, i = new A$1(n).toHexString(), l = reactive({
      hueColor: i,
...
const be = (e) => (pushScopeId("data-v-7f0cdcdf"), e = e(), popScopeId(), e);
const vt = /* @__PURE__ */ be(() => /* @__PURE__ */ createElementVNode("div", { class: "vc-saturation__white" }, null, -1));
const bt = /* @__PURE__ */ be(() => /* @__PURE__ */ createElementVNode("div", { class: "vc-saturation__black" }, null, -1));
const yt = /* @__PURE__ */ be(() => /* @__PURE__ */ createElementVNode("div", null, null, -1));
const _t = [
  yt
];
...
const kt = (e) => (pushScopeId("data-v-e1a08576"), e = e(), popScopeId(), e);
const $t = /* @__PURE__ */ kt(() => /* @__PURE__ */ createElementVNode("div", { class: "vc-hue-slider__bar-handle" }, null, -1));
const wt = [
  $t
];
...
const Rt = (e) => (pushScopeId("data-v-94a50a9e"), e = e(), popScopeId(), e);
const At = /* @__PURE__ */ Rt(() => /* @__PURE__ */ createElementVNode("div", { class: "vc-lightness-slider__bar-handle" }, null, -1));
const Pt = [
  At
];
...
function Lt(e, t, o, n, i, l) {
  return e.colors && e.colors.length > 0 ? (openBlock(), createElementBlock("div", Et, [
    createElementVNode("div", It, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(e.colors, (a, r) => (openBlock(), createElementBlock("div", {
        key: r,
  ...
  return openBlock(), createElementBlock("div", Wt, [
    createElementVNode("div", Dt, [
      createElementVNode("div", {
        ...
        e.copied ? (openBlock(), createElementBlock("span", Tt, "Copied!")) : createCommentVNode("", true)
      ], 4)
    ]),
    e.inputType === "hex" ? (openBlock(), createElementBlock("div", Ot, [
      ...
      e.disableAlpha ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", Gt, [
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(e.state.rgba, (a, r) => (openBlock(), createElementBlock("div", {
    ...
    }, toDisplayString$1(e.inputType), 1)
  ]);
}
...
const Ut = defineComponent({
  ...
  setup(e, { emit: t }) {
    const o = e.color || new A$1(), n = reactive({
      color: o,
      hex: o.toHexString(),
      rgb: o.toRgbString()
    }), i = ref(false), l = computed(() => ({ background: n.rgb })), a = () => {
...
const jt = (e) => (pushScopeId("data-v-48e3c224"), e = e(), popScopeId(), e);
const Zt = { class: "vc-fk-colorPicker" };
const Jt = { class: "vc-fk-colorPicker__inner" };
const Qt = { class: "vc-fk-colorPicker__header" };
const xt = /* @__PURE__ */ jt(() => /* @__PURE__ */ createElementVNode("div", { class: "back" }, null, -1));
const eo = [
  xt
];
function to(e, t, o, n, i, l) {
  ...
  return openBlock(), createElementBlock("div", Zt, [
    createElementVNode("div", Jt, [
      ...
      e.advancePanelShow ? createCommentVNode("", true) : (openBlock(), createBlock(a, {
        key: 0,
      ...
      e.advancePanelShow ? createCommentVNode("", true) : (openBlock(), createBlock(k, {
        key: 3,
        color: e.state.color,
        onChange: e.onLightChange
      }, null, 8, ["color", "onChange"])),
      e.disableAlpha ? createCommentVNode("", true) : (openBlock(), createBlock(p, {
        key: 4,
        color: e.state.color,
      ...
      e.disableHistory ? createCommentVNode("", true) : (openBlock(), createBlock(d, {
        key: 5,
    ...
    createElementVNode("div", ao, [
      createElementVNode("div", ro, [
        createElementVNode("div", lo, [
          ...
          e.disableAlpha ? createCommentVNode("", true) : (openBlock(), createBlock(c, {
            key: 0,
            size: "small",
            color: e.state.color,
            onChange: e.onAlphaChange
      ...
      e.disableHistory ? createCommentVNode("", true) : (openBlock(), createBlock(p, {
        key: 0,
        round: e.roundHistory,
        colors: e.historyColors,
        onChange: e.onCompactChange
...
const Ne = (e) => (pushScopeId("data-v-c4d6d6ea"), e = e(), popScopeId(), e);
...
const Ho = ["title"];
const Ro = /* @__PURE__ */ Ne(() => /* @__PURE__ */ createElementVNode("span", { class: "vc-gradient__stop--inner" }, null, -1));
const Ao = [
  Ro
];
const Po = ["title"];
const Vo = /* @__PURE__ */ Ne(() => /* @__PURE__ */ createElementVNode("span", { class: "vc-gradient__stop--inner" }, null, -1));
const Mo = [
  Vo
];
function Eo(e, t, o, n, i, l) {
  ...
  return openBlock(), createElementBlock("div", po, [
    createElementVNode("div", fo, [
      ...
      createElementVNode("div", Co, [
        createElementVNode("div", vo, [
          ...
          }, toDisplayString$1(e.lang ? e.lang[y] : y), 3)), 64))
        ]),
    ...
    e.advancePanelShow ? createCommentVNode("", true) : (openBlock(), createBlock(p, {
      key: 3,
      color: e.currentColor,
      onChange: e.onLightChange
    }, null, 8, ["color", "onChange"])),
    e.disableAlpha ? createCommentVNode("", true) : (openBlock(), createBlock(g, {
      key: 4,
      color: e.currentColor,
      onChange: e.onAlphaChange
    }, null, 8, ["color", "onChange"])),
    ...
    e.disableHistory ? createCommentVNode("", true) : (openBlock(), createBlock(m, {
      key: 5,
      round: e.roundHistory,
      colors: e.historyColors,
      onChange: e.onCompactChange
        ...
        createElementVNode("div", No, [
          createElementVNode("div", {
            ...
            createElementVNode("button", null, [
              createElementVNode("div", Wo, toDisplayString$1((a = e.lang) == null ? void 0 : a.pure), 1)
            ])
          ], 2),
          createElementVNode("div", {
            class: normalizeClass([
            ...
            createElementVNode("button", null, [
              createElementVNode("div", Do, toDisplayString$1((r = e.lang) == null ? void 0 : r.gradient), 1)
            ])
          ], 2),
          createElementVNode("div", {
...
const qo = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    const o = !!useSlots().extra, n = reactive({
      ...
      //  "pure" | "gradient"
      isAdvanceMode: false
    }), i = new A$1("#000"), l = new A$1("#000"), a = new A$1(n.pureColor), r = reactive({
      startColor: i,
      endColor: l,
      startColorStop: 0,
      endColorStop: 100,
    ...
    e.isWidget ? (openBlock(), createBlock(a, {
      ...
      default: withCtx(() => [
        ...
        e.hasExtra ? (openBlock(), createElementBlock("div", Yo, [
          renderSlot(e.$slots, "extra", {}, void 0, true)
        ])) : createCommentVNode("", true)
      ]),
      _: 3
    }, 8, ["active-key", "show-tab", "style", "theme", "onChange"])) : createCommentVNode("", true),
    e.isWidget ? createCommentVNode("", true) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
      createElementVNode("div", {
...
function U(t, e, i, s, r, o) {
  return openBlock(), createElementBlock("div", {
    ...
    withDirectives(createElementVNode("div", {
      ...
      }, toDisplayString$1(t.cropInfo.width) + " \xD7 " + toDisplayString$1(t.cropInfo.height), 5)) : createCommentVNode("", true),
...
export { DesignPanel, MyPrinter, cellTypeFormat, install as createPrint, displayStrategyFormat, elementTypeFormat, mountDesign, statisticsTypeFormat, version };
